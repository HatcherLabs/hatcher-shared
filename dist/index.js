...
__export(index_exports, {
  ...
  AI_CREDIT_DEFAULT_MARGIN_MULTIPLIER: () => AI_CREDIT_DEFAULT_MARGIN_MULTIPLIER,
  AI_CREDIT_MIN_CHARGE: () => AI_CREDIT_MIN_CHARGE,
  AI_CREDIT_UNIT_USD: () => AI_CREDIT_UNIT_USD,
  ...
  HATCHER_HOSTED_MODEL_RECOMMENDATIONS: () => HATCHER_HOSTED_MODEL_RECOMMENDATIONS,
  PLUGIN_LIMITS: () => PLUGIN_LIMITS,
  PRICING: () => PRICING,
  SOLANA_CONFIG: () => SOLANA_CONFIG,
  TIERS: () => TIERS,
  TIER_AI_CREDITS_MONTHLY: () => TIER_AI_CREDITS_MONTHLY,
  TIER_KEYS: () => TIER_KEYS,
...
var HATCHER_HOSTED_MODEL_RECOMMENDATIONS = [
  ...
  },
  {
    ...
    costTier: "low",
    context: "128K",
    description: "OpenServ reasoning model for low-cost, quick agent responses."
  },
  {
    ...
    costTier: "medium",
    context: "1M",
    description: "OpenServ reasoning model with strong long-context price-performance."
  },
  {
    ...
    costTier: "high",
    context: "1M",
    description: "Higher-capability OpenServ reasoning model for complex agent workflows."
  },
  {
  ...
  },
  {
    ...
    costTier: "medium",
    context: "200K",
    description: "Partner-hosted Claude Sonnet through AceData for hosted inference and agent workflows."
  },
  {
