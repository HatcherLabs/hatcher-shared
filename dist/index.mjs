...
var require_types = __commonJS({
  "src/types/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BYOK_PROVIDER_ENV_VARS = void 0;
    exports.ok = ok;
    exports.err = err;
    function ok(data) {
    ...
    exports.BYOK_PROVIDER_ENV_VARS = {
...
var require_constants = __commonJS({
  "src/constants/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PAID_TIER = exports.AGENT_STATUS_CONFIG = exports.AGENT_STATUSES = exports.AGENT_TEMPLATES = exports.PRICING = exports.FREE_TIER_MAX_AGENTS = exports.ACCOUNT_AGENT_LIMITS = exports.SOLANA_CONFIG = exports.RATE_LIMITS = exports.FRAMEWORKS = exports.BYOK_PROVIDERS = exports.TOKEN_ECONOMY = exports.ADDONS = exports.TIER_ORDER = exports.TIERS = void 0;
    exports.getTier = getTier;
    exports.getAddon = getAddon;
    exports.getBYOKProvider = getBYOKProvider;
    exports.TIERS = {
      free: {
        key: "free",
        name: "Free",
    ...
    exports.TIER_ORDER = ["free", "basic", "pro"];
    exports.ADDONS = [
    ...
    function getTier(key) {
      ...
      return exports.TIERS[normalized] ?? exports.TIERS.free;
    }
    function getAddon(key) {
      return exports.ADDONS.find((a) => a.key === key);
    }
    exports.TOKEN_ECONOMY = {
      symbol: "TOKEN",
      name: "Token"
    };
    exports.BYOK_PROVIDERS = [
      {
        key: "groq",
        name: "Groq",
    ...
    function getBYOKProvider(key) {
      return exports.BYOK_PROVIDERS.find((p) => p.key === key);
    }
    exports.FRAMEWORKS = {
      openclaw: {
        key: "openclaw",
    ...
    exports.ACCOUNT_AGENT_LIMITS = {
      "account.agents.5": 5,
      "account.agents.20": 20,
      "account.agents.unlimited": Infinity
    };
    exports.FREE_TIER_MAX_AGENTS = 1;
    exports.PRICING = {
...
- Match enthusiasm to the writer's energy \u2014 creative work is personal, treat it with care`
    ...
    exports.AGENT_STATUSES = ["active", "sleeping", "paused", "error", "killed", "restarting"];
...
// src/index.ts
var index_exports = {};
__reExport(index_exports, __toESM(require_types()));
__reExport(index_exports, __toESM(require_constants()));
