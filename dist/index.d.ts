...
declare const AGENT_TEMPLATES: readonly [{
    ...
    readonly defaultBio: "AI language tutor that remembers your level, tracks your vocabulary gaps, practices conversation, and delivers personalized corrections — improving with every session.";
    ...
    readonly defaultBio: "AI content writer that remembers your brand voice, audience, and past content — producing on-brand blog posts, social media copy, and marketing materials every time.";
